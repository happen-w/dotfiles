...
_G.packer_plugins = {
  ...
  ["nerdtree_choosewin-plugin"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/nerdtree_choosewin-plugin",
    url = "https://kkgithub.com/happen-w/nerdtree_choosewin-plugin"
  },
  ["neuleetcode.vim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/neuleetcode.vim",
  ...
  ["nvim-code-action-menu"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/opt/nvim-code-action-menu",
    url = "https://kkgithub.com/weilbith/nvim-code-action-menu"
  },
  ["nvim-gdb"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/nvim-gdb",
  ...
  ["vim-buffet"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/vim-buffet",
    url = "https://kkgithub.com/bagrat/vim-buffet"
  },
  ["vim-choosewin"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/vim-choosewin",
  ...
  ["vim-markdown-toc"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/vim-markdown-toc",
  ...
  ["vim-quickrun"] = {
    ...
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/vim-quickrun",
    url = "https://kkgithub.com/thinca/vim-quickrun"
  },
  ["vim-table-mode"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/vim-table-mode",
